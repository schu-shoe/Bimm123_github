Mini Project: Pathway Analysis from RNA-Seq Results
================
Siena Schumaker
...
```
    ...
    ENSG00000237330         0         0         0         0         1         0
    ENSG00000131591       115       135       169       143       174       225
...
```
    ...
    ENSG00000237330         0         0         0         0         1         0
    ENSG00000131591       115       135       169       143       174       225
    ENSG00000186891         2         0         0         0         2         0
    ENSG00000186827         0         0         1         1         2         1
    ENSG00000078808      3355      3427      4634      4963      5313      6517
    ENSG00000176022       555       744       925       950      1059      1339
...
![](MiniProject-Pathway-analysis-_files/figure-commonmark/unnamed-chunk-11-1.png)
...
![](MiniProject-Pathway-analysis-_files/figure-commonmark/unnamed-chunk-12-1.png)
...
```
    ...
    Info: Working in directory /Users/sienaschumaker/Downloads/BIMM 143 labs/Bimm143_github/Mini Project: Pathway Analysis from RNA-Seq Results
...
``` r
topkeggrespathways <- rownames(keggres$less)[1:5]
topkeggresids = substr(topkeggrespathways, start=1, stop=8)
topkeggresids
```
...
``` r
pathview(gene.data=foldchanges, pathway.id=topkeggresids, species="hsa")
```
...
endosomal/vacuolar pathway. The most significant pathways listed do
match the previous KEGG results to an extent. The KEGG results showed
the cell cycle as having the smallest p-value which has the second and
third lowest entities p-value in reactome. A major factors that could
cause differences between the two methods are that for the reactome, it
also includes different molecules that could be in the pathways whereas
KEGG does not (considers cells only)
